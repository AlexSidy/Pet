...
# ScanPerson 🌐
## О проекте
ScanPerson — это проект для самообучения и тестирвоания, призванный продемонстрировать полный цикл разработки приложения "под ключ". Основная идея — создание многосервисной архитектуры на базе .NET Core Web API 9 с клиентской частью на Angular 17. 
