...
# ScanPerson 🌐
## О проекте
ScanPerson — это проект для самообучения и тестирвоания, призванный продемонстрировать полный цикл разработки приложения "под ключ". Основная идея — создание многосервисной архитектуры на базе .NET Core 9 Web API с клиентской частью на Angular 17. 
